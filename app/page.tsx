      ...
      <div className="main-header w-nav">
        <div className="header_container w-container">
          <div className="header_wrapper">
            <div className="logo_wrapper"><a href="/" aria-current="page" className="header_logo w-nav-brand w--current"><Image src="images/main-logo-growmodo-black.svg" width={1024} height={1024} loading="lazy" alt="" className="logo-image_color" /></a></div>
            <nav role="navigation" className="nav-menu w-nav-menu">
              <div className="nav-link_wrapper why-us"><a href="#" className="nav_link font_space-grotesk w-nav-link">Why Us</a></div>
              <div className="nav-link_wrapper"><a href="/showcase" className="nav_link w-nav-link">What's included?</a></div>
              <div className="nav-link_wrapper"><a href="/talents" className="nav_link w-nav-link">Showcase</a></div>
              <div className="nav-link_wrapper"><a href="/scope" className="nav_link w-nav-link">Blog</a></div>
